...
public class G28ShortestPathUGUnitWeights {
    ...
    public static void main(String[] args) {
        ...
        //Below is using Method 2
        int[] result=shortestPathUsingVisitedArray(adjlist,V,E,src);
        System.out.println("####################");
    ...
    private static int[] shortestPathUsingVisitedArray(List<List<Integer>> adjlist,int V, int E,int src) {
