...
import leetcode.designPatterns.Problems.VendingMachine.VendingStates.State;
...
public class Main {
    ...
    private static void fillUpInventory(VendingMachine vendingMachine){
        ...
        ItemShelf[] itemShelf = vendingMachine.getInventory().getShelf();
    ...
    private static void displayInventory(VendingMachine vendingMachine){
        ...
        ItemShelf[] slots = vendingMachine.getInventory().getShelf();
