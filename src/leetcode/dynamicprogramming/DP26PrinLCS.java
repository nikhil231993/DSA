...
public class DP26PrinLCS {
    ...
    public static void main(String[] args) {
        ...
        //Recursion
        System.out.println(recursion(text1,text2,index1,index2));

        //Memoization
        int[][] dp1=new int[index1+1][index2+1];
        for(int[] r:dp1)
            Arrays.fill(r,-1);
        System.out.println(memoization(text1,text2,index1,index2,dp1));
        ...
        char[] ch=new char[dp2[index1][index2]];
        int k=ch.length-1;
        while(i>0 && j>0){
