...
//		}
		...
		System.out.println("Topology in BFS: ");
		ArrayList<Integer> topSort = bfsTopology(adjList, n);
	...
	private static ArrayList<Integer> bfsTopology(ArrayList<ArrayList<Integer>> adjList, int n) {
