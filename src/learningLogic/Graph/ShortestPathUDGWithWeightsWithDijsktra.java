...
class NodeVertex implements Comparator<NodeVertex> {
	int v;
	int w;
	...
	@Override
	public int compare(NodeVertex o1, NodeVertex o2) {
		if (o1.w < o2.w) {
			return -1;
		}
		if (o1.w > o2.w) {
...
public class ShortestPathUDGWithWeightsWithDijsktra {
	...
	private static void createGraph() {
		...
		for (int i = 1; i <= m; i++) {
			...
			adjList.get(v).add(new NodeVertex(u, w));
		}
